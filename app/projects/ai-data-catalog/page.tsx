...
export default function AiDataCatalogPage() {
  return (
    <ProjectDetail
      ...
      hiringSignal="This project shows how Ted connects governance, metadata, and AI enablement into a practical product interface for banking, insurance, healthcare, and enterprise data teams that need to move faster without losing control of risk."
    />
  );
}
